"""Climate platform from Midea Connect."""
...
async def async_setup_entry(
    ...
    """Setup the climate platform for Midea Connect."""
...
class MideaClimateDevice(MideaCoordinatorEntity[MideaDevice], ClimateEntity, Generic[MideaDevice]):
    ...
    def device_info(self) -> dict:
        ...
        return {
            ...
            "name": (getattr(self.coordinator, "device_name", None) or
                     f"Midea {self._device.type:X} {self._device.id}"),
            "manufacturer": "Midea",
        }
